-- ============================================================================
-- ADD REMAINING COLUMNS FIRST, THEN INDEXES, RLS, TRIGGERS, FUNCTIONS
-- ============================================================================
...
SELECT 'Customers columns added!' as result;
...
SELECT 'Customer vehicles columns added!' as result;
