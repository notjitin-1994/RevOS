...
-- ============================================================================
-- This script drops and recreates the customers and customer_vehicles tables
-- with the correct UUID column types from the start
...
CREATE TABLE public.customers (
  ...
  -- Foreign key constraint - references garages table
...
COMMENT ON COLUMN public.customers.garage_id IS 'Foreign key reference to garages table (UUID), references garages.garage_uid';
...
COMMENT ON COLUMN public.customer_vehicles.garage_id IS 'Foreign key reference to garages table (UUID), references garages.garage_uid';
