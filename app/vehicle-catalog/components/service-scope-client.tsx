...
export function ServiceScopeClient({ initialMakes }: ServiceScopeClientProps) {
  ...
  // Simulate initial loading state for animation
  useEffect(() => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-8">
        ...
        >
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="bg-gray-200 rounded-xl p-4 md:p-6">
              <div className="h-4 bg-gray-300 rounded animate-pulse w-20 mb-2" />
              <div className="h-7 bg-gray-300 rounded animate-pulse w-12" />
            </div>
          ))}
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-white border border-gray-200 rounded-xl p-4 md:p-6 mb-6"
        >
