...
RevvOS uses a **light mode** design system with professional graphite tones and clean white surfaces. The design emphasizes clean, professional aesthetics suitable for automotive workshop environments.
...
|-------|-----|-------|----------------|
| **Brand Primary** | `#0F172A` | Primary CTAs, sidebar background, accent elements | `bg-graphite-900` |
| **Brand Hover** | `#334155` | Hover states for brand elements | `bg-graphite-700` |
...
<button className="
  ...
  bg-graphite-900 hover:bg-graphite-700
...
**Rules:**
- Background: `bg-graphite-900` (#0F172A)
- Text: `text-white` - **Use white text on graphite buttons**
- Hover: `bg-graphite-700` (#334155)
...
<input
  className="
    ...
    focus:ring-2 focus:ring-graphite-900
...
- Background: `bg-white`
- Border: `border-gray-300`
- Focus ring: `focus:ring-2 focus:ring-graphite-900`
- Text: `text-gray-900`
...
| `shadow-lg` | `0 10px 15px -3px rgba(0, 0, 0, 0.3)` | Elevated elements |
...
- Graphite accent for professional appearance
- Clean, neutral tones for focus
...
- Use `text-white` on `bg-graphite-900` buttons
...
- ❌ Use colored text on Graphite-900 backgrounds (use white)
